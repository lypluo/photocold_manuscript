...
save(par_PFTs,file = paste0("data/model_parameters/parameters_MAE_newfT/","optim_par_run5000_PFTs_noNorm.rds"))

#--------------------------------------------------------------
#(5) compare the gpp_obs, ori modelled gpp, and gpp modelled using optimated parameters
#--------------------------------------------------------------
load(paste0("./data/model_parameters/parameters_MAE_newfT/","optim_par_run5000_PFTs_noNorm.rds"))
...
#-----------------------------
#need to back-convert the normalized gpp to gpp-->do not need in this script
#-----------------------------
