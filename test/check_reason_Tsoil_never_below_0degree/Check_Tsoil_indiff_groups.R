...
#SWC_top3-->mean of first 3 layers:
...
p_SWC_1_len5_b60$plot<-p_SWC_1_len5_b60$plot+
  ylab("SWC (%)")
p_SWC_top3_len5_b60$plot<-p_SWC_top3_len5_b60$plot+
  ylab("SWC (%)")
#--------------
...
#update in 2022,Oct-->at the end-->do not use the average data in first 3 layers
#-->as the the avaiablity from 3 layers differs a lot-->results in the different results for SWC
p_merge_1<-plot_grid(
...
plot_grid(
  p_ppfd_len5_b60$plot,p_temp_min_len5_b60$plot,
  p_TS_top3_len5_b60$plot,p_SWC_top3_len5_b60$plot,
  labels = "auto",ncol=2,label_size = 18,align = "hv"
)
