...
# save(par_Clim_PFTs,file = paste0("data/model_parameters/parameters_MAE_newfT_logistic/","optim_par_run5000_Clim_andPFTs.rds"))

#--------------------------------------------------------------
#(5) compare the gpp_obs, ori modelled gpp, and gpp modelled using optimated parameters
#--------------------------------------------------------------
#load model parameters
load(paste0("./data/model_parameters/parameters_MAE_newfT_logistic/","optim_par_run5000_Clim_andPFTs.rds"))
#check par_Clim_PFTs
print(par_Clim_PFTs)
...
ggsave(paste0(save.path,"Figure5_pmodel_vs_obs_forClimPFTs_Mekela2008_logistic.png"),season_plot,width = 20,height = 20)
